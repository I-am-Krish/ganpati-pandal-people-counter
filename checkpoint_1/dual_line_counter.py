...
class SingleLineCounter:
    ...
    """
    def __init__(self, line_start, line_end, dead_zone=15, cooldown_frames=30, timeout_seconds=10.0):
    ...
    def update(self, detections):
        ...
        for i in range(len(detections)):
            ...
            # Use CENTER of bbox (more stable than bottom-center in overhead cameras)
            x1, y1, x2, y2 = bbox
            px = (x1 + x2) / 2.0
            py = (y1 + y2) / 2.0
            point = (px, py)
